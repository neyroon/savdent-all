    ...
    <>
      ...
      <Section>
        <div className="py-[70px] ">
          ...
          <h5>
            <span className="text-[25px]">1. Общие положения</span>
            <br />
            <br />
            <br />
          </h5>
          <p>
            <span>
              ...
              152-ФЗ &laquo;О персональных данных&raquo; (далее &mdash; Закон о
            ...
            <span>Сафаровым Эльбрусом Эльмановичем</span>
            <span> (далее &mdash; Оператор).</span>
            <br />
            <br />
            <br />
          </p>
          ...
          <p>
            ...
            <Link href="https://safdent.ru">https://safdent.ru</Link>
            <span>.</span>
            <br />
            <br />
          </p>
          ...
          <p>
            <span>
              ...
              данных для распространения, &mdash; персональные данные, доступ
              ...
              данных (далее &mdash; персональные данные, разрешенные для
              распространения).
            </span>
            <br />
            <br />
          ...
          <p>
            <span>2.10. Пользователь &mdash; любой посетитель веб-сайта </span>
            <Link href="https://safdent.ru">https://safdent.ru</Link>
            <span>.</span>
            <br />
            <br />
          ...
          <p>
            <span>
              2.14. Уничтожение персональных данных &mdash; любые действия, в
          ...
          <p>
            <span>
              &mdash; в случае отзыва субъектом персональных данных согласия на
          ...
          <p>
            <span>
              &mdash; сообщать в уполномоченный орган по защите прав субъектов
          ...
          <p>
            <span>
              &mdash; исполнять иные обязанности, предусмотренные Законом о
              персональных данных.
            </span>
            <br />
            <br />
          ...
          <p>
            <span>
              &mdash; на отзыв согласия на обработку персональных данных, а
          ...
          <p>
            <span>
              &mdash; обжаловать в уполномоченный орган по защите прав субъектов
              ...
              <tr>
                ...
                <td>
                  <ul>
                    ...
                    <li>
                      <span>год, месяц, дата и место рождения</span>
                    </li>
                    <li>
          ...
          <p>
            ...
            <Link href={`mailto:safdent@bk.ru`}>safdent@bk.ru</Link>
            <span>
              {" "}
          ...
          <h5>
            <span className="text-[25px]">12. Заключительные положения</span>
            <br />
            <br />
            <br />
          </h5>
          ...
          <p>
            ...
            <Link href="https://safdent.ru/privacy">
              https://safdent.ru/privacy
            </Link>
            <span>.</span>
            <br />
            <br />
